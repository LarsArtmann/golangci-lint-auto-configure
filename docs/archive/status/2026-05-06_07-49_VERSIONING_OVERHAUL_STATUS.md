...
The versioning work we just did is the kind of thing that matters _most_ for a public release: users need to know what version they're running. Without a public decision, items 19-25 above are all blocked.
